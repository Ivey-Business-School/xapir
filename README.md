...
the endpoint returned. The post table has 24 columns (`paid_partnership`
and `community_id` are new in 0.2.0) and the user table 24
(`media_count`, `verified_followers_count`, `subscription_type`,
`parody`, `profile_banner_url` and `pinned_post_id` are new).
