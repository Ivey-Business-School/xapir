...
#' hook and the entities it mentions. An app bearer token is enough. The
#' endpoint has no language parameter: stories come in the language X has
#' set for the app or account, so a French-language app gets French news.
#'
